...
namespace BlueRibbonsReview.Controllers
{
    public class CampaignsController : Controller
    {
       ...
       // GET: Campaigns/BuyerDetails/
        ...
        public ActionResult GetPercentageDiscount()
        {
        ...
        //public ActionResult EditFakeDetails(int campaignId) //for ko js edit details page
        //{
        //    Campaign campaign = db.Campaigns.Find(campaignId);
        //    return PartialView("_Details", campaign);
        //}
